      ...
      <div ref={sectionRef} className="relative h-[400vh] bg-[#0a0a0a]">
        <div className="sticky top-0 h-screen overflow-hidden flex flex-col justify-center">
          ...
          <div className="absolute top-10 left-10 md:left-20 z-10 mix-blend-difference pointer-events-none">
            <h2 className="text-4xl md:text-6xl font-serif italic mb-2">Our Portfolio</h2>
            <p className="text-xs uppercase tracking-widest opacity-70">Curating Heartfelt Experiences</p>
          </div>
